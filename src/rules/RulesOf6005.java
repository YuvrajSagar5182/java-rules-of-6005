...
public class RulesOf6005 {
	...
	public static boolean mayUseCodeInAssignment(boolean writtenByYourself,
	    ...
	    // If the code was written as part of a 6.005 assignment in the current or past semesters, you can use it.
	    ...
	    // If the assignment specifically requires you to implement the feature, you can use it.
